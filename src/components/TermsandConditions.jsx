...
const TermsandConditions = () => {
  return (
    <div class=" w-[75%] mx-auto py-3 dark:text-white">
      ...
      <br />
      <p>
        This website is operated by <b>Anuj Kamal Jain. </b>
      ...
      <p>
        ...
        information), may be transferred unencrypted and involve <br />
        (a) transmissions over various networks; and <br />
        (b) changes to conform and adapt to the technical requirements of
      ...
      <p>
        ...
        time without notice, at our sole discretion of us. We reserve the right
      ...
      <p>
        ...
        religion, ethnicity, race, age, national origin, or disability; <br />
        ...
        <br />
        (l) to share access or account details, which will result in the
        temporary or permanent blocking of the account;
        <br />
        (m) to use the course content only for individual use and not to share
        it.
      </p>
      <br />
      <hr />
      ...
      <br />
      <p>
        In no case shall <b>Anuj Kamal Jain,</b>
      ...
      <br />
      <b>
        <h1>SECTION 17 - LIFETIME ACCESS</h1>
      </b>
      <br />
      <p>
        &quot;Lifetime access &quot;refers to a one-time payment that grants the
        purchaser continued access to a product, service, or platform for the
        duration of its availability and active support by the provider or
        company. It does not imply access for the literal lifetime of the user
        or company, but rather for the lifetime of the product or service as
        determined solely by the provider.
      </p>
      <br />
      <p>
        Lifetime access is considered valid only while the relevant product or
        service is maintained, supported, or offered by the company. If the
        company chooses to discontinue or retire the product or service, access
        may be terminated without any obligation to provide a refund.
      </p>
      <br />
      <p>
        Access is non-transferable and limited to the original purchaser.
        Continued access also requires compliance with all applicable terms,
        policies, and guidelines. Failure to comply may result in immediate
        suspension or revocation of access without notice.
      </p>
      <br />
      <p>
        The company reserves the right to modify, restrict, or terminate
        lifetime access in response to legal, technical, or business-related
        reasons. No representation or warranty is made regarding indefinite
        availability or perpetual support.
      </p>
      <br />
      <hr />
      <br />
      <b>
        <h1>SECTION 18 - ENTIRE AGREEMENT</h1>
      </b>
      <br />
      <p>
      ...
      <br />
      <b>
        <h1>SECTION 19 - GOVERNING LAW</h1>
      </b>
      <br />
      <p>
        These Terms of Service and any separate agreements whereby we provide
        you Services shall be governed by and construed in accordance with the
        laws of India and the jurisdiction of Ambala, Haryana
      </p>
      <br />
      <hr />
      <br />
      <b>
        <h1>SECTION 20 - CHANGES TO TERMS OF SERVICE</h1>
      </b>
      <br />
      <p>
      ...
      <br />
      <b>
        <h1>SECTION 21 - CONTACT INFORMATION</h1>
      </b>
      <br />
      <p>
